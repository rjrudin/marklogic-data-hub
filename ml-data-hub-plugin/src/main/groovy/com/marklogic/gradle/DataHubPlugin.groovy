...
class DataHubPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        DeployToReplicaTask deployToReplicaTask = project.tasks.getByName("mlDeployToReplica")
        deployToReplicaTask.setCommandListSupplier({dataHub.buildCommandsForDeployingToReplica()})
